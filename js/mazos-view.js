...
(function () {
  ...
  // FUENTE del meta: 'limitless' (el de torneos del juego real) o el meta PROPIO de tcgmini
  ...
  // scrape_meta_decks.py); las propias = data/meta_tcgmini.js (lo genera meta_interno.js).
  ...
  function _mzbBuildSearch() {
    ...
    // Cartas CUSTOM de tcgmini: chip APARTE y SIEMPRE el último; solo existe si el formato
  ...
  const DECK_IMG_CFG = {
    horizontal:{bgColor:'#0d0d0d',iconColor:'#1a1a1a',iconOpacity:67,iconSize:45,iconStep:120,iconLayout:'brick',badgeShape:'pent',boxColor:'#141414',boxOpacity:91,boxBorder:0,badgeSize:17,energySize:32,showOnes:1,margin:0,cardShadow:0,wmText:'TCGmini.com',wmSize:15,wmMargin:4,wmOpacity:35,wmShadow:0},
    vertical:{bgColor:'#0d0d0d',iconColor:'#1a1a1a',iconOpacity:65,iconSize:90,iconStep:110,iconLayout:'brick',badgeShape:'pent',boxColor:'#141414',boxOpacity:91,boxBorder:0,badgeSize:17,energySize:56,showOnes:1,margin:0,cardShadow:0,wmText:'TCGmini.com',wmSize:40,wmMargin:26,wmOpacity:40,wmShadow:0},
    line:{bgColor:'#0d0d0d',iconColor:'#1a1a1a',iconOpacity:100,iconSize:40,iconStep:133,iconLayout:'brick',badgeShape:'pent',boxColor:'#141414',boxOpacity:91,boxBorder:0,badgeSize:17,energySize:32,showOnes:1,margin:23,cardShadow:0,wmText:'TCGmini.com',wmSize:36,wmMargin:0,wmOpacity:60,wmShadow:100}
  };
