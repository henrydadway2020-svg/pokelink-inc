...
(function () {
  ...
  const F = {
    ...
    customOnly:   false,       // chip de Avanzados: ver SOLO las cartas custom de tcgmini
  ...
  //    cualquier URL externa (tcgmini.com, GitHub, o cualquier otro host) que
